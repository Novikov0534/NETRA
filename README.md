...
NETRA загружает JSON-файл с описанием узлов и связей, строит интерактивный 2D-граф, показывает нагрузку цветом и толщиной линий, а также подсвечивает недоступные и проблемные узлы.
...
- Загрузка пользовательского JSON-файла.
